...
placa $50\times50$ cm), $t_{req}=47.7$ mm con NTC-DCEA 2017 y con NTC-DCEA 2023, resultado
...
redimensionamiento bajo la NTC-DCEA 2023. En el caso evaluado con ancla A325 de 7/8'' y dado de
70~cm, la distancia disponible es $c_{disp}=15.0$~cm, que cumple NTC-DCEA 2017
($c_{min,2017}=13.3$~cm) pero no cumple NTC-DCEA 2023 ($c_{min,2023}=15.6$~cm), con una
