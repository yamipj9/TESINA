% apendiceC.tex
\chapter{Apéndice C: Algoritmos de cálculo en pseudocódigo}
\label{ch:apendiceC}
...
(Metodología) y constituyen el núcleo computacional del trabajo. El código Python completo
se encuentra en el notebook \texttt{notebooks/analisis\_parametrico.ipynb}.
