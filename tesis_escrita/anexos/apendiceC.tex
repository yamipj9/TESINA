...
\begin{algorithm}[H]
  ...
  \begin{algorithmic}[1]
    ...
    \State \textbf{Factores modificadores (cap. 2, norma NTC-acero 2017):}
...
\textbf{Salidas:} Distancia mínima al borde según NTC-acero 2017: $c_{min,2017}$ (cm);
según NTC-acero 2023: $c_{min,2023}$ (cm).
